...
class Core(object):
    ...
    def login(self, enableCmdQR=False, handlerQRfunc=None, picDir=None, qrCallback=None,
    ...
    def get_QRuuid(self):
        ...
        '''
        raise NotImplementedError()
    def get_QR(self, uuid=None, enableCmdQR=False, handlerQRfunc=None, picDir=None, qrCallback=None):
